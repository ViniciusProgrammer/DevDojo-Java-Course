...
/**
 * 0 - Bloco de inicializção estático da superclasse é executado quando a JVM carrega a superclasse
 * 1 - Bloco de inicializção estático da superclasse é executado quando a JVM carrega a classe filha
